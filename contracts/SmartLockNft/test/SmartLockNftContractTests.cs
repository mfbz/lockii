...
namespace Lockii.SmartLockNftTests
{
	[CheckpointPath("test/bin/checkpoints/contract-deployed.neoxp-checkpoint")]
	public class SmartLockNftContractTests : IClassFixture<CheckpointFixture<SmartLockNftContractTests>>
	{
		readonly CheckpointFixture fixture;
		readonly ExpressChain chain;

		public SmartLockNftContractTests(CheckpointFixture<SmartLockNftContractTests> fixture)
		{
			this.fixture = fixture;
			this.chain = fixture.FindChain("SmartLockNftTests.neo-express");
		}
		...
		public void contract_owner_in_storage()
		{
			/*
				...
				var storages = snapshot.GetContractStorages<SmartLockNftContract>();
		...
		public void can_change_number()
		{
			/*
				...
				engine.ExecuteScript<SmartLockNftContract>(c => c.changeNumber(42));
				...
				var storages = snapshot.GetContractStorages<SmartLockNftContract>();
				var contractStorage = storages.StorageMap("SmartLockNftContract");
